...
class Alipay {
    ...
    function buildRequestFormHTML($params, $method = 'post', $target = '_self') {
        ...
        $html .= "<form id='alipaysubmit' name='alipaysubmit' action='" . $this->gateway . "' _input_charset='" . trim(strtolower($this->config['input_charset'])) . "' method='" . $method . "' target='".$target."'>";
